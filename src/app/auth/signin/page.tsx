  ...
  return (
    <main className="auth-page">
      <div className="auth-card fade-in">
        ...
        {/* Email / Password */}
        <form action="/api/auth/signin/credentials" method="POST" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div className="field">
        ...
        <p style={{ textAlign: "center", marginTop: "24px", fontSize: "0.8125rem" }}>
