    ...
    <div className="fade-in" style={{ maxWidth: "800px", margin: "0 auto" }}>
      ...
      >
        <button
          ...
          className={`btn ${activeTab === "starter" ? "btn-secondary" : "btn-ghost"}`}
          style={{
            fontWeight: 600,
            borderColor: activeTab === "starter" ? "var(--brand-primary)" : "transparent",
          }}
        >
      ...
      {activeTab === "starter" ? (
        <div className="card">
          ...
          >
            💡 <strong>Tip:</strong> Choose from the starter templates below to test immediate
            deployment with the built-in local container simulator, or switch to{" "}
            <strong>Custom Git Repository URL</strong> to deploy your own code.
          </div>
          ...
          {loadingRepos ? (
            ...
            <div className="empty-state">
              ...
              <p>You can deploy by entering a Git URL directly in the Custom URL tab.</p>
            </div>
          ) : (
        ...
        <div className="card">
          ...
          <p style={{ fontSize: "0.875rem", color: "var(--text-muted)", marginBottom: "20px" }}>
            Enter any public Git repository URL. Portway will auto-detect the runtime language and
